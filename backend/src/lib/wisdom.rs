...
static WISDOM: &[&str] = &[
    ...
    "You can say anything as long as you say 'just kidding'",
    "Only Tarantino writing can get close to my tweet level.",
    ...
    "You may be talented, but you're not not kanye west.",
    ...
    "I feel so bad for my exes like image losing me.",
    "And I love you like Kanye loves Kanye.",
    "I'm fucking gold, but if you prefer silver that's okay.",
    "There's a little bit of Lamborgini in everything I do.",
