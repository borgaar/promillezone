...
class HouseholdApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [HouseholdResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HouseholdResponse>> createHousehold({ 
    required CreateHouseholdRequest createHouseholdRequest,
    ...
    try {
      const _type = FullType(CreateHouseholdRequest);
      _bodyData = _serializers.serialize(createHouseholdRequest, specifiedType: _type);
    ...
    HouseholdResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HouseholdResponse),
    ...
    return Response<HouseholdResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InviteCodeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InviteCodeResponse>> createInviteCode({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/household/invite';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    InviteCodeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InviteCodeResponse),
      ) as InviteCodeResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [HouseholdResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HouseholdResponse>> joinHousehold({ 
    required JoinHouseholdRequest joinHouseholdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/household/join';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(JoinHouseholdRequest);
      _bodyData = _serializers.serialize(joinHouseholdRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> leaveHousehold({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/household/leave';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
