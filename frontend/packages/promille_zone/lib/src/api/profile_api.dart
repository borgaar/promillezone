...
class ProfileApi {
  ...
  Future<Response<ProfileResponse>> createProfile({ 
    ...
    final _path = r'/api/auth/profile';
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createProfileRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProfileResponse>> verifyProfile({ 
    required VerifyProfileRequest verifyProfileRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/auth/profile/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(VerifyProfileRequest);
      _bodyData = _serializers.serialize(verifyProfileRequest, specifiedType: _type);
